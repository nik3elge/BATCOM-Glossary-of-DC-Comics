...
Глоссарий не навязывает «правильные» варианты перевода и не претендует на роль окончательного авторитета. Его задача — зафиксировать и упорядочить сложившуюся практику, чтобы выбор конкретного варианта был осознанным. Если переводчик принимает иное решение — так тому и быть. Но теперь решение может опираться на понимание существующих вариантов и их контекста, а не быть результатом случайности или невнимательности.
