...
[![entries](https://img.shields.io/badge/entries-2232-orange)](https://dc.nananabat.com)
...
Функционал сайта полностью готов: пользователи могут просматривать и искать термины, ориентироваться в существующих переводах и использовать справочник как удобный инструмент для работы с DC Comics.
...
Хотя функционал сайта не планируется расширять в ближайшее время, проект будет развиваться через обновление глоссария:
